...
class TestCardTableManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger = Mock()
        self.manager = CardTableManager(self.table, self.cards, logger=self.logger)
    ...
    def test_apply_filter_type(self):
        ...
        # Filter for instants - directly set the filter instead of relying on UI signals
        self.filter_combo.setCurrentText("Instants")
        self.manager.filter_manager.set_type_filter("Instants")
    ...
    def test_search_filter(self):
        ...
        # Search for "bolt" - directly set the search text instead of relying on UI signals
        self.search_input.setText("bolt")
        self.manager.filter_manager.set_search_text("bolt")
